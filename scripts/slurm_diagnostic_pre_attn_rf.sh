#!/bin/bash -l
#SBATCH --job-name=SpecPT_pre_attn_RF
...
EXP_NAME=${EXP_NAME:-exp_046_pre_attn_RF}
N_ESTIMATORS=${N_ESTIMATORS:-100}

python scripts/diagnostic_pre_attn_rf.py --exp_name ${EXP_NAME} --n_estimators ${N_ESTIMATORS} --n_jobs 8
