...
| 2 | `exp_021` | **0.01506** | **24.07%** | 400 | patience 50→100. |
| 3 | `exp_014` | **0.01640** | **23.78%** | 295 | dropout_rate=0.1. |
| 4 | `exp_019` | **0.01670** | **24.70%** | 355 | batch_size 128→256. |
| 5 | `exp_023` | **0.016995** | **23.60%** | 502 | lr 1e-4→5e-5. |
| 6 | `exp_022` | **0.01712** | **23.99%** | 342 | epochs 400→600. |
| 7 | `exp_030` | **0.01816** | **23.84%** | 267 | Curriculum (50%→100%). **2nd best NMAD.** |
| 8 | `exp_025` | **0.01848** | **23.85%** | 254 | TTA (N=10). Best among outlier reduction experiments. |
| 9 | `exp_020` | **0.01909** | **23.55%** | 318 | warmup_epochs 500→50. |
| 10 | `exp_027` | **0.01934** | **24.25%** | 241 | Two-Stage (200+200, 4x outlier weight). |
| 11 | `exp_024` | **0.01950** | **23.30%** | 462 | weight_decay 5e-5→1e-4. |
| 12 | `exp_028` | **0.01987** | **23.79%** | 229 | Per-Sample Weights (inverse error by z-bin). |
| 13 | `exp_018` | **0.02062** | **23.74%** | 238 | mlp_dim 1024→768. |
| 14 | `exp_016` | **0.02100** | **24.04%** | 210 | weight_decay=1e-5. |
