...
|------------|----------|-----------|--------|--------|
| exp_059 | REGULARIZATION A/B #1 on simv4a_v2 — head dropout_rate 0.1→0.3 (frozen AE dropout stays 0.1) | — | — | running (tigris job 90003) |
| exp_060 | REGULARIZATION A/B #2 on simv4a_v2 — num_mlp_blocks 12→5 (less capacity) | — | — | running (tigris job 90004) |
| exp_061 | REGULARIZATION A/B #3 on simv4a_v2 — weight_decay 5e-5→1e-4 | — | — | running (tigris job 90005) |
