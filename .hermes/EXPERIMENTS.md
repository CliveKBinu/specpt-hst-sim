...
| Catastrophic Outliers | **22.86%** | **exp_008_v2** |
| ECE | — | — |
| RMSE | 0.375 | exp_008 |
| Val Loss | 0.348 | exp_008 |
...
| exp | config | run_id | run_name | best_nmad | final_nmad | final_outs | val_z_bias | val_rmse | val_loss | notes |
|-----|--------|--------|----------|-----------|------------|------------|------------|----------|----------|-------|
| exp_011 | configs/exp_011.yaml | — | — | — | — | — | — | — | — | mlp_dim 512→1024 (wider head), pretrained_redshift="" (train head from scratch). Tests if increased head width improves NMAD now that shape-mismatch constraint is removed. |
